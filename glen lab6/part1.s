 ...
 *
 * This routine toggles the HEX3-0 displays to either 0 or blank,
 * respective to which key was pressed
 ****************************************************************************************/
.global     KEY_ISR
KEY_ISR:
...
/* Clear edge capture register */
        ...
        LDR        R0, =HEX3_HEX0_BASE        // set up a pointer to the HEX3-0 base address in R0 (we can reuse R0 now)
        LDR     R0, [R0]       // load value of HEX3-0
        
        MVN     R2, #0            // start R2 at #-1
        //MOVS    R3, R1
//KEY_VALUE:
    //my code
...
light_1000:
            PUSH     {R12}
            MOV     R12, #1325400064  // 4F 00 00 00
            STR     R12, [R6]
            POP      {R12}
            B       END_KEY_ISR
